...
add_cells_to_pblock [get_pblocks pblock_tile_y0x0] [get_cells -quiet [list chip/bp_processor/cc/y[0].x[0].tile_node/tile]]
resize_pblock [get_pblocks pblock_tile_y0x0] -add {CLOCKREGION_X0Y4:CLOCKREGION_X3Y5}

create_pblock pblock_tile_y0x1
add_cells_to_pblock [get_pblocks pblock_tile_y0x1] [get_cells -quiet [list chip/bp_processor/cc/y[0].x[1].tile_node/tile]]
resize_pblock [get_pblocks pblock_tile_y0x1] -add {CLOCKREGION_X4Y4:CLOCKREGION_X7Y5}

create_pblock pblock_tile_y1x0
add_cells_to_pblock [get_pblocks pblock_tile_y1x0] [get_cells -quiet [list chip/bp_processor/cc/y[1].x[0].tile_node/tile]]
resize_pblock [get_pblocks pblock_tile_y1x0] -add {CLOCKREGION_X0Y2:CLOCKREGION_X3Y3}

create_pblock pblock_tile_y1x1
add_cells_to_pblock [get_pblocks pblock_tile_y1x1] [get_cells -quiet [list chip/bp_processor/cc/y[1].x[1].tile_node/tile]]
