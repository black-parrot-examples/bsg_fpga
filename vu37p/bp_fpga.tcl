...
#
# Generated by Vivado on Thu Sep 03 15:09:20 PDT 2020
...
proc cr_bd_design_4 { parentCell } {
  ...
  set fetch_v [ create_bd_port -dir I -from 0 -to 0 fetch_v ]
  ...
  # Create port connections
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins ila_0/clk]
  connect_bd_net -net probe0_0_1 [get_bd_ports fetch_v] [get_bd_pins ila_0/probe0]
