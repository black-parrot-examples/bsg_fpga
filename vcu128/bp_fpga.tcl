...
set files [list \
 ...
 [file normalize "${blackparrot_dir}/external/basejump_stl/bsg_misc/bsg_counter_clock_downsample.v"] \
 [file normalize "${origin_dir}/v/design_1_wrapper.v"] \
 [file normalize "${origin_dir}/sdk/install/ucode/moesif.mem"] \
]
...
set file "$blackparrot_dir/external/basejump_stl/bsg_misc/bsg_counter_clock_downsample.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/sdk/install/ucode/moesif.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
