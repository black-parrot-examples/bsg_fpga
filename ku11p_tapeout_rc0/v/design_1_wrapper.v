...
*/
  ...
  bsg_chip chip
  (.p_ci_clk_i (GW_IC0_CL_CLK)
  ,.p_ci_v_i   (GW_IC0_CL_V)
  ,.p_ci_tkn_o (GW_IC0_CL_TKN)
  ,.p_ci_0_i   (GW_IC0_CL_D0)
  ,.p_ci_1_i   (GW_IC0_CL_D1)
  ,.p_ci_2_i   (GW_IC0_CL_D2)
  ,.p_ci_3_i   (GW_IC0_CL_D3)
  ,.p_ci_4_i   (GW_IC0_CL_D4)
  ,.p_ci_5_i   (GW_IC0_CL_D5)
  ,.p_ci_6_i   (GW_IC0_CL_D6)
  ,.p_ci_7_i   (GW_IC0_CL_D7)
  ,.p_ci_8_i   (GW_IC0_CL_D8)
  ...
  ,.p_ci2_clk_o(IC0_GW_CL_CLK)
  ,.p_ci2_v_o  (IC0_GW_CL_D4)
  ,.p_ci2_tkn_i(IC0_GW_CL_TKN)
  ,.p_ci2_0_o  (IC0_GW_CL_D6)
  ,.p_ci2_1_o  (IC0_GW_CL_D5)
  ,.p_ci2_2_o  (IC0_GW_CL_D7)
  ,.p_ci2_3_o  (IC0_GW_CL_D8)
  ,.p_ci2_4_o  (IC0_GW_CL_D3)
  ,.p_ci2_5_o  (IC0_GW_CL_V)
  ,.p_ci2_6_o  (IC0_GW_CL_D2)
  ,.p_ci2_7_o  (IC0_GW_CL_D1)
  ,.p_ci2_8_o  (IC0_GW_CL_D0)
 ...
 #(.width_p(1)
  ...
  bsg_chip_swizzle_adapter
    swizzle
      ...
      ,.port_co_clk_i   (IC0_GW_CL_CLK)
      ,.port_co_v_i     (IC0_GW_CL_V)
      ,.port_co_data_i  ({IC0_GW_CL_D8, IC0_GW_CL_D7, IC0_GW_CL_D6, IC0_GW_CL_D5, IC0_GW_CL_D4, IC0_GW_CL_D3, IC0_GW_CL_D2, IC0_GW_CL_D1, IC0_GW_CL_D0})
      ,.port_co_tkn_o   (IC0_GW_CL_TKN)

      ,.port_co2_clk_o  (GW_IC0_CL_CLK)
      ,.port_co2_v_o    (GW_IC0_CL_D4)
      ,.port_co2_data_o ({GW_IC0_CL_D0, GW_IC0_CL_D1, GW_IC0_CL_D2, GW_IC0_CL_D3, GW_IC0_CL_D5, GW_IC0_CL_D6, GW_IC0_CL_V, GW_IC0_CL_D7, GW_IC0_CL_D8})
      ,.port_co2_tkn_i  (GW_IC0_CL_TKN)
